# Old Robotiq Gripper Control Scripts

:::{warning}
This documentation is for the old gripper control scripts. Please refer to [gripper_control.md](gripper_control.md) for the latest version.
:::
...
```
Of gebeurt automatisch bij het starten van de robot met `ros2 launch my_robot_bringup bringup.launch.py`.
